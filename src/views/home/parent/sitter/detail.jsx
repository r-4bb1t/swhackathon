...
export default function SitterDetail() {
  ...
  const [showStartTimeHourDrawer, setShowStartTimeHourDrawer] = useState(false);
  ...
  const [showEndTimeMinuteDrawer, setShowEndTimeMinuteDrawer] = useState(false);
  ...
  const YearContent = () => {
    return (
      <div className="p-4 flex flex-col  mt-5 max-h-72 text-black text-subtitle-lg">
        <button className="my-3" onClick={() => handleYearSelect("2023")}>
          2023년
        </button>
        <button className="my-3" onClick={() => handleYearSelect("2024")}>
          2024년
        </button>
    ...
    return (
      <div className="flex flex-col justify-center">
        ...
        <div className="child">
          ...
          <div className=" text-body text-black-600 pl-10">23년 4월생</div>
        </div>
        <div className="child">
          {" "}
          <div className="flex items-center">
        ...
        <div className=" flex justify-center">
          <Button
            ...
            className={` w-3/4 fixed bottom-10 ${
              isButtonActive ? "bg-primary" : "bg-black-400 border-none"
            }`}
          >
            다음
          </Button>
    ...
    return (
      <div>
        ...
        <div className="date-button-wrap mt-2 flex justify-around px-10">
          ...
          >
            {applicationInfo.dateDay ? applicationInfo.dateDay + "일" : "일"}
          </button>
        </div>
        ...
        <div className="flex mt-2 items-center justify-between">
          <div className="flex">
            ...
            <button
              ...
              className="w-16 text-h1 btn btn-outline flex justify-between"
            >
              {applicationInfo.endTimeHour ? applicationInfo.endTimeHour : "00"}
            </button>
            <div className=" text-h1 mx-2">:</div>
            <button
  ...
  return (
    <div className="w-full flex flex-col shrink pt-14">
      ...
      <div className="w-full p-8 pt-4">
        ...
        <div className="text-subtitle-bold mb-4">가능한 돌봄 서비스</div>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title">23년생 4월생 부모, 관악구</h2>
            <p>
              아이를 꼭 영어유치원에 보내야할까요? 주변 엄마들이 다들 보내고
              있어서 고민되네요...
            </p>
            <div className="card-actions justify-end">
              <div className="badge badge-lg badge-outline border-none">
                <Icons.Comment className="w-5 h-5 mr-1"></Icons.Comment>2
              </div>
              <div className="badge badge-lg badge-outline border-none">
      ...
      {/* Render Day Drawer */}
      {showDayDrawer && (
        <BottomDrawer isVisible={showDayDrawer} onClose={handleCloseDayDrawer}>
          <DayContent />
        </BottomDrawer>
      )}
