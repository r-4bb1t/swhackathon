...
function ParentChildrenBirth() {
  ...
  const yearContent = (index) => (
    <div className=" p-4 flex flex-col overflow-y-auto mt-5 max-h-72 text-black text-subtitle-lg">
      <button className=" my-3" onClick={() => handleYearSelect("2012", index)}>
        2012년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2013", index)}>
        2013년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2014", index)}>
        2014년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2015", index)}>
        2015년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2016", index)}>
        2016년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2017", index)}>
        2017년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2018", index)}>
        2018년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2019", index)}>
        2019년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2020", index)}>
        2020년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2021", index)}>
        2021년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2022", index)}>
        2022년
      </button>
      <button className=" my-3" onClick={() => handleYearSelect("2023", index)}>
        2023년
      </button>
    </div>
  );
  const monthContent = (index) => (
    <div className="p-4 flex flex-col overflow-y-auto mt-5 text-black text-subtitle-lg">
      <button className=" my-3" onClick={() => handleMonthSelect("01", index)}>
        1월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("02", index)}>
        2월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("03", index)}>
        3월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("04", index)}>
        4월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("05", index)}>
        5월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("06", index)}>
        6월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("07", index)}>
        7월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("08", index)}>
        8월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("09", index)}>
        9월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("10", index)}>
        10월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("11", index)}>
        11월
      </button>
      <button className=" my-3" onClick={() => handleMonthSelect("12", index)}>
        12월
      </button>
    </div>
  );
      ...
      <div className="content-wrap h-full flex flex-col justify-between p-6">
        <div className="h-full shrink">
          ...
          <div className="flex flex-col">
            ...
            {childrenData.map((child, index) => (
              <div key={index} className=" mb-2">
                ...
                <div className="flex justify-evenly">
                  <button
                    onClick={() => handleOpenDrawer(yearContent(index))}
                  ...
                  <button
                    onClick={() => handleOpenDrawer(monthContent(index))}
            ...
            {showDrawer && (
              <BottomDrawer isVisible={showDrawer} onClose={handleCloseDrawer}>
                {drawerContent}
              </BottomDrawer>
            )}
          </div>
